...
- [x] Quanto a região deveria ter vendido até hoje e qual é seu atingimento sobre essa meta parcial?
- [x] Quantos XP de vendas são calculados pelo atingimento da meta parcial da região?
...
- Visão de Venda no Quadrimestre implementada em 15/09/2026: usa a meta disponível de setembro, calcula sua parcela pelos dias úteis decorridos e mostra realizado líquido elegível, atingimento exato, XP, saldo e ritmo necessário por região. Os vendedores aparecem para identificar a composição das vendas, sem dividir ou duplicar o XP regional.
...
- Ao filtrar um mês: para vendas, comparar o realizado desse mês com sua meta parcial até a referência e exibir os XP atuais desse atingimento, conforme confirmado em 14/09/2026. Em mês encerrado, usar a meta mensal completa. Identificar o mês e a data de referência; os tetos de novos e reativados continuam no acumulado da campanha por vendedor, e o teto de antecipação no acumulado por região.
