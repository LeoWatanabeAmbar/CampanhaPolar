...
- Adiantamento, **confirmado em 14/09/2026 e ampliado em 16/09/2026**: receber de uma das cinco contas editoras autorizadas três checks `true`/`false` por região e mês. Usar diretamente a versão salva, sem calcular datas de encerramento, conferir percentuais contra vendas ou inferir uma fase a partir de outra.
