...
- Indicadores principais na primeira tela: **confirmado pelo usuário**, metas regionais publicadas até o mês atual, meta acumulada até a referência, realizado regional acumulado desde setembro, dias úteis restantes, meta diária do mês atual, percentual de atingimento acumulado e XP de vendas calculado para a região. Manter uma única meta e um único resultado regional mesmo com dois vendedores no mês. Proposta complementar: saldo das metas publicadas e venda necessária por dia útil restante.
...
- Visão de Venda no Quadrimestre implementada em 15/09/2026 e ajustada após confirmação do usuário: acumula os meses desde setembro. Meses encerrados entram com meta e vendas integrais; o mês atual entra com vendas até a referência e meta proporcional aos dias úteis. Mostra atingimento exato, XP, saldo e ritmo necessário por região. Os vendedores aparecem para identificar a composição das vendas, sem dividir ou duplicar o XP regional.
